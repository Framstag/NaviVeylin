...
- The default overrun multiplier SHALL be 2.5×
...
- **WHEN** user pans 50 pixels right on a 1080×1920 screen with 2.5× overrun
- **THEN** the new viewport rectangle (offset by 50px) is within the 2700×4800 overrun buffer
...
- **WHEN** user pans 1000 pixels right on a 1080×1920 screen with 2.5× overrun
- **THEN** the new viewport rectangle extends beyond the 2700×4800 overrun buffer
