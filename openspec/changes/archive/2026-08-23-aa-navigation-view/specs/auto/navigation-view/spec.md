...
- **THEN** auto-zoom stops adjusting the zoom until the speed crosses a band boundary
...
The system SHALL let the user stop active navigation from the car display at any time.
