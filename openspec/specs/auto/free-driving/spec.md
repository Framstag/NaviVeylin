...
The system SHALL display the current street name on the free-driving view, derived from the map data at the GPS position, centered at the bottom of the view.
