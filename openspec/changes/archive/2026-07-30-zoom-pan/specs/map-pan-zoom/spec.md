...
- On zoom change, the system SHALL immediately display a scaled placeholder from the current front buffer
- Zoom gesture events SHALL be debounced at 200ms before triggering a full re-render
