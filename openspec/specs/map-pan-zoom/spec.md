# Map Pan Zoom Specification

## Purpose

Support touch-based pan (single-finger drag) and pinch-to-zoom gestures on the map canvas.
## Requirements
...
- At gesture end, the system SHALL commit the unrounded magnification `startMag + log2(gestureZoom)` — no rounding to an integer level
