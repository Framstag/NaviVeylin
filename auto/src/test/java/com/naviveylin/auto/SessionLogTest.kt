...
class SessionLogTest {
    ...
    fun lifecycleEventsAreLogged() {
        ...
        assertTrue(entries.any { it.contains(SessionLog.WARMUP_TAG) && it.contains("Entry point resolved") })
        assertTrue(entries.any { it.contains(SessionLog.WARMUP_TAG) && it.contains("Building native client") })
        assertTrue(entries.any { it.contains(SessionLog.WARMUP_TAG) && it.contains("Native client ready") })
