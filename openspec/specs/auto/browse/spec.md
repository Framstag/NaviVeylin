...
Browse map mode for Android Auto: a destination-free fullscreen map with GPS position marker, compass, speed indicator, and current street name, entered from the map menu.
