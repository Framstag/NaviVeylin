...
/**
 * German translation completeness for the `:core` resources (spec: German is
 * fully supported, turn-instruction-localization): every translatable string
 * in the default `values/` must exist in `values-de/`. Plain JUnit — Gradle
 * runs unit tests with the module dir as working directory.
 */
